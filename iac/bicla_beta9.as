...
INT_MASK        EQU     1000110000000111b ;Interrupções activadas;
...
Nivel4TEMP:	MOV	R1,0002h
		MOV	M[ValorTemp],R1

TerminaVerifica:POP	R1
		RET
...
GAMEOVER:	MOV	M[HouveColisao],R0
		RET
