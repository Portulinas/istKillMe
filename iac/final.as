...
Apagou_Alea1:	CALL	Soma_Display
		CALL	Aleatorio1st
		MOV	R1,M[Random]
		ADD	R1,001Ch
		MOV	M[Barreira_1],R1
...
Apagou_Alea2:	CALL	Soma_Display
		CALL	Aleatorio1st
		MOV	R1,M[Random]
		ADD	R1,001Ch
		MOV	M[Barreira_2],R1
...
Apagou_Alea3:	CALL	Soma_Display
		CALL	Aleatorio1st
		MOV	R1,M[Random]
		ADD	R1,001Ch
		MOV	M[Barreira_3],R1
...
Apagou_Alea4:	CALL	Soma_Display
		CALL	Aleatorio1st
		MOV	R1,M[Random]
		ADD	R1,001Ch
		MOV	M[Barreira_4],R1
