// $Id: PFwriter.h,v 1.29 2012-05-15 17:08:04 ist169630 Exp $ -*- c++ -*-
/*
 * $Log: PFwriter.h,v $
 * Revision 1.29  2012-05-15 17:08:04  ist169630
 * updates
 *
 * Revision 1.28  2012-05-15 16:04:50  ist169643
 * stuff
 *
 * Revision 1.27  2012-05-15 10:27:11  ist169643
 * *** empty log message ***
 *
 * Revision 1.26  2012-05-15 07:50:22  ist169643
 * *** empty log message ***
 *
 * Revision 1.25  2012-05-14 20:59:56  ist169630
 * update
 *
 ...
 *
 * Revision 1.17  2012-04-11 07:55:38  ist169630
 * moved
 *
 * Revision 1.16  2012-04-10 13:29:58  uid169643
 * fuction up to date
 *
 * Revision 1.15  2012-03-29 22:43:08  ist169643
 * weee 2 new nodes weeee
 *
 * Revision 1.14  2012-03-29 18:06:29  ist169643
 * está organizado!!!
 *
 * Revision 1.13  2012-03-29 15:39:58  ist169643
 * Version [Loading 98%]
 *
 * Revision 1.12  2012-03-29 10:48:17  ist169643
 * epah todos os visitores Conhecidos(com todo a frente) foram feitos
 *
 * Revision 1.11  2012-03-28 23:20:27  ist169643
 * all bugs corrected (i hope)
 *
 * Revision 1.10  2012-03-28 22:33:35  ist169643
 * some errors corrected
 *
 * Revision 1.9  2012-03-28 18:49:57  ist169630
 * *** empty log message ***
 *
 * Revision 1.8  2012-03-28 09:09:06  ist169643
 ...
 *
 * Revision 1.4  2012-03-25 14:54:36  ist169643
 * bug corrected
 *
 ...
 *
 * Revision 1.10  2011/03/07 02:27:04  david
 * Added simple left value for read and assignment operations.
 *
 * Revision 1.9  2011/03/06 16:12:42  david
 * Updated for CDK6.
 *
...
#ifndef __TLL_SEMANTICS_PFWRITER_H__
#define __TLL_SEMANTICS_PFWRITER_H__
...
namespace tll {
  namespace semantics {
    ...
    class PFwriter: public virtual SemanticProcessor {
      ...
      int _lbl;
    public:
      PFwriter(std::ostream &os, bool debug, cdk::semantics::SymbolTable<TLLSymbol> &symtab,
    ...
    public:
	  ...
	  void processFunctionCallNode(tll::node::expression::FunctionCallNode * const node,
								int lvl);
	  void processFunctionDeclNode(tll::node::FunctionDeclNode * const node,
									int lvl);
