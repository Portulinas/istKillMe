# procura NW e SE estao feitos, porem teremos de fazer um procura_string diferente para as diagonais
# no procura_palavras fiz sub_funcoes devido a abstracao procedimental
