# funcoes e_resposta e resposta a realizar os mesmos testes ? 
# podiamos chamar e_resposta na funcao resposta, o que achas? 

# No teste 37 existe inconsistencia com o enunciado, a funcao procura_palavras_...
# devolve a string da coordenada, no entanto existe um teste repostas_iguais com um argumento que 
# nao e uma string proveniente do R = resposta
