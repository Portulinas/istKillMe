...
/**
 *  Example of how to insert and retrieve cipher data to and from XML,
 *  using base 64 encoding to represent ciphered data as text
 */
public class XmlCipher {

    public static final String XML = "<message>" +
        "<body>There and Back Again</body>" +
        "</message>";
