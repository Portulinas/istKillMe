...
static char simbolo1 = 'O';
static char simbolo2 = 'X';
...
int play(int row, int column, int player) {
    ...
    board[row][column] = (player == 1) ? simbolo2 : simbolo1;  /* Insert player symbol   */
